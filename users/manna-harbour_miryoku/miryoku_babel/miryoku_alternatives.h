...
KC_Q,              KC_W,              KC_F,              KC_P,              KC_B,              KC_J,              KC_L,              KC_U,              KC_Y,              KC_QUOT,           \
LGUI_T(KC_A),      LALT_T(KC_R),      LCTL_T(KC_S),      LSFT_T(KC_T),      HYPR_T(KC_G),      HYPR_T(KC_M),      LSFT_T(KC_N),      LCTL_T(KC_E),      LALT_T(KC_I),      LGUI_T(KC_O),      \
LT(BUTTON, KC_Z),  ALGR_T(KC_X),      KC_C,              LCAG_T(KC_D),      KC_V,              KC_K,              LCAG_T(KC_H),      KC_COMM,           ALGR_T(KC_DOT),    LT(BUTTON, KC_SLSH), \
U_NP,              U_NP,              LT(MEDIA, KC_ESC), LT(MOUSE, KC_TAB), LT(NAV, KC_SPC),   LT(SYM, KC_BSPC),  LT(NUM, KC_ENT),   LT(FUN, KC_DEL),   U_NP,              U_NP
...
KC_Q,              KC_W,              KC_E,              KC_R,              KC_T,              KC_Y,              KC_U,              KC_I,              KC_O,              KC_P,              \
LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      HYPR_T(KC_G),      HYPR_T(KC_H),      LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_QUOT),   \
...
KC_GRV,            KC_1,              KC_2,              KC_3,              KC_BSLS,           U_NA,              LLOCK,             U_NA,              KC_ALGR,           U_NA,              \
...
KC_TILD,           KC_EXLM,           KC_AT,             KC_HASH,           KC_PIPE,           KC_F15,            KC_F14,            U_NA,              KC_ALGR,           U_NA,              \
...
KC_F10,            KC_F1,             KC_F2,             KC_F3,             KC_PAUS,           U_NA,              LLOCK,             U_NA,              KC_ALGR,           U_NA,              \
